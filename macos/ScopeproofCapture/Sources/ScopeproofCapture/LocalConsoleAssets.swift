...
enum LocalConsoleAssets {
    ...
    static let css = #"""
    .evidence-card p{overflow-wrap:anywhere}
    ...
    (() => {
      ...
      function evidenceCard(item) {
        ...
        actions.append(reveal,review); body.append(kicker,title,meta,period); if(source) body.append(source); body.append(tags,actions); card.append(image,body); return card;
      }
