...
| [2026-09-01 security and product remediation](SECURITY_REMEDIATION_2026-09-01.md) | Security engineering, product owners, operators, and release approvers | See which findings are implemented in source, how the hosted/native workflows changed, what must be configured and validated externally, and why the source changes are not an AWS deployment or public Mac release. |
