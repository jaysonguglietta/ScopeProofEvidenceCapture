...
- Review decisions and findings are persisted as audited event streams. Two-person hosted hold release binds a 24-hour request to the exact hold facts and requires a different administrator. Assessor export performs a fail-closed preflight for eligibility, coverage, independent screenshot safety, native provenance, and package bounds.
